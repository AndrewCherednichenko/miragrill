...
import TableForBanquetes from '../_components/tables/TableForBanquetes';
...
export default function Banketi() {
  ...
  useEffect(() => {
    if (!isLoading && pictureData && pictureData.attributes && pictureData.attributes.banketi) {
      // console.log(pictureData.attributes.banketi.data.attributes.url);
      setPicture(pictureData.attributes.banketi.data.attributes.url);
    }
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            gutterBottom
          >
            Наш ресторан предлагает идеальное пространство для проведения банкетов и фуршетов, подходящее для различных торжественных мероприятий.
            <br />
            <br />
            Общая вместимость заведения составляет до 136 человек, что позволяет организовать как камерные, так и масштабные события.
            <br />
          </Typography>
          <Grid
            sx={{
